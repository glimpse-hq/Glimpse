...
- Parakeet Unified 0.6B ONNX (NVIDIA Open Model License, English-only streaming, all builds except Intel macOS): via [`bobNight/parakeet-unified-en-0.6b-onnx`](https://huggingface.co/bobNight/parakeet-unified-en-0.6b-onnx)
